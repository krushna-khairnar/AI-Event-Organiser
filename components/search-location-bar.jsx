      ...
      <div className="relative flex w-full" ref={searchRef}>
        <div className="flex-1">
          ...
          <Input
            ...
            onFocus={() => {
              if (searchInputValue.length >= 2) setShowSearchResults(true);
            }}
        ...
        {/* Search Results */}
        {showSearchResults && (
          <div className="absolute top-full mt-2 w-96 bg-background border rounded-lg shadow-lg z-50 max-h-96 overflow-y-auto">
            {searchLoading ? (
